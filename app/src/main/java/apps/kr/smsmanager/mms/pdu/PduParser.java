...
import apps.kr.smsmanager.mms.pdu.DeliveryInd;
import apps.kr.smsmanager.mms.pdu.EncodedStringValue;
import apps.kr.smsmanager.mms.pdu.GenericPdu;
import apps.kr.smsmanager.mms.pdu.NotificationInd;
import apps.kr.smsmanager.mms.pdu.NotifyRespInd;
import apps.kr.smsmanager.mms.pdu.PduContentTypes;
import apps.kr.smsmanager.mms.pdu.PduHeaders;
import apps.kr.smsmanager.mms.pdu.QuotedPrintable;
import apps.kr.smsmanager.mms.pdu.ReadOrigInd;
import apps.kr.smsmanager.mms.pdu.ReadRecInd;
            ...
            if (header > TEXT_MAX) {
                ...
                switch (header) {
                    ...
                    case PduPart.P_CONTENT_DISPOSITION:
                         ...
                         * field correctly
                         */
                        boolean contentDisposition = Resources.getSystem().getBoolean(11);
